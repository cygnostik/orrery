...
- `MOON_MODEL.range` directly shares `SCIENCE.range`: **1800-01-01T00:00:00Z through 2250-01-01T00:00:00Z, inclusive**. This is an application guardrail, **not an accuracy interval for these schematic moons**.
